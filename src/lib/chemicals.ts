...
export const CHEMICAL_CATEGORIES: Record<string, Chemical[]> = {
    ELEMENTS: [
        ...
        { formula: 'La', name: 'Lanthanum', isElement: true, effects: { color: '#d3d3d3' } }, { formula: 'Ce', name: 'Cerium', isElement: true, effects: { color: '#d3d3d3' } },
        { formula: 'Pr', name: 'Praseodymium', isElement: true, effects: { color: '#d3d3d3' } }, { formula: 'Nd', name: 'Neodymium', isElement: true, effects: { color: '#d3d3d3' } },
        { formula: 'Pm', name: 'Promethium', isElement: true, effects: { color: '#d3d3d3', glow: 1.3 } }, { formula: 'Sm', name: 'Samarium', isElement: true, effects: { color: '#d3d3d3' } },
        { formula: 'Eu', name: 'Europium', isElement: true, effects: { color: '#d3d3d3' } }, { formula: 'Gd', name: 'Gadolinium', isElement: true, effects: { color: '#d3d3d3' } },
        { formula: 'Tb', name: 'Terbium', isElement: true, effects: { color: '#d3d3d3' } }, { formula: 'Dy', name: 'Dysprosium', isElement: true, effects: { color: '#d3d3d3' } },
        { formula: 'Ho', name: 'Holmium', isElement: true, effects: { color: '#d3d3d3' } }, { formula: 'Er', name: 'Erbium', isElement: true, effects: { color: '#d3d3d3' } },
        { formula: 'Tm', name: 'Thulium', isElement: true, effects: { color: '#d3d3d3' } }, { formula: 'Yb', name: 'Ytterbium', isElement: true, effects: { color: '#d3d3d3' } },
        { formula: 'Lu', name: 'Lutetium', isElement: true, effects: { color: '#d3d3d3' } },
        ...
        { formula: 'Am', name: 'Americium', isElement: true, effects: { color: '#c0c0c0', glow: 1.7 } }, { formula: 'Cm', name: 'Curium', isElement: true, effects: { color: '#c0c0c0', glow: 1.9 } },
        { formula: 'Bk', name: 'Berkelium', isElement: true, effects: { color: '#c0c0c0', glow: 1.8 } }, { formula: 'Cf', name: 'Californium', isElement: true, effects: { color: '#c0c0c0', glow: 2.0 } },
        { formula: 'Es', name: 'Einsteinium', isElement: true, effects: { color: '#c0c0c0', glow: 2.0 } }, { formula: 'Fm', name: 'Fermium', isElement: true, effects: { color: '#c0c0c0' } },
        { formula: 'Md', name: 'Mendelevium', isElement: true, effects: { color: '#c0c0c0' } }, { formula: 'No', name: 'Nobelium', isElement: true, effects: { color: '#c0c0c0' } },
        { formula: 'Lr', name: 'Lawrencium', isElement: true, effects: { color: '#c0c0c0' } }, { formula: 'Rf', name: 'Rutherfordium', isElement: true, effects: { color: '#c0c0c0' } },
        { formula: 'Db', name: 'Dubnium', isElement: true, effects: { color: '#c0c0c0' } }, { formula: 'Sg', name: 'Seaborgium', isElement: true, effects: { color: '#c0c0c0' } },
        { formula: 'Bh', name: 'Bohrium', isElement: true, effects: { color: '#c0c0c0' } }, { formula: 'Hs', name: 'Hassium', isElement: true, effects: { color: '#c0c0c0' } },
        { formula: 'Mt', name: 'Meitnerium', isElement: true, effects: { color: '#c0c0c0' } }, { formula: 'Ds', name: 'Darmstadtium', isElement: true, effects: { color: '#c0c0c0' } },
        { formula: 'Rg', name: 'Roentgenium', isElement: true, effects: { color: '#c0c0c0' } }, { formula: 'Cn', name: 'Copernicium', isElement: true, effects: { color: '#c0c0c0' } },
        { formula: 'Nh', name: 'Nihonium', isElement: true, effects: { color: '#c0c0c0' } }, { formula: 'Fl', name: 'Flerovium', isElement: true, effects: { color: '#c0c0c0' } },
        { formula: 'Mc', name: 'Moscovium', isElement: true, effects: { color: '#c0c0c0' } }, { formula: 'Lv', name: 'Livermorium', isElement: true, effects: { color: '#c0c0c0' } },
        { formula: 'Ts', name: 'Tennessine', isElement: true, effects: { color: '#c0c0c0' } }, { formula: 'Og', name: 'Oganesson', isElement: true, effects: { color: '#c0c0c0' } },
    ],
    LIQUIDS: [
