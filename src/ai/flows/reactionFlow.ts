...
const prompt = ai.definePrompt({
  ...
  **Your Task:**
  ...
  2.  **Description**: A clear, step-by-step description of the chemical process. **You MUST explain how 'temperature', 'concentration', and 'grade' affect the reaction's rate, equilibrium, and outcome.**
      -   For 'grade': Explain the impact of the selected grade. 'consumer' grade may have impurities leading to side reactions or lower yield. 'lab' grade is the standard. 'reagent' grade ensures high purity and optimal results. For 'consumer' grade, be realistic about what's "DIY"—e.g., getting Lithium from batteries is plausible, but synthesizing complex compounds is not.
